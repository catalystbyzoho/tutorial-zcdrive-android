...
{{%announcement%}}You are using old version of SDK to get lattest version {{%span id="ios"%}}{{%/span%}} {{%link href="#" target="_self" %}}click here{{%/link%}}{{%/announcement%}}

# Authentication - ios - v1
