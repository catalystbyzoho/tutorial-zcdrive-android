...
sdk:
  ...
  sdk_item:
    ...
    - name : "Java"
      icon : "java-icon"
      link : "/java/authentication/"
      
    - name : "Node JS"
      icon : "nodejs-icon"
      link : "/nodejs/authentication/"

    - name : "Android"
      icon : "android-icon"
      link : "/android/authentication/"

    - name : "iOS"
      icon : "ios-icon"
      link : "/ios/authentication/"

    - name : "Java Script"
      icon : "js-icon"
      link : "/javascript/authentication/"
      ...
      - title: "Develop"
        featuredpoints:
          ...
          - name: "Data Store"
            ...
            link: "/help/data-store/"
            content: "Lorem Ipsum is simply dummy text of the printing and typesetting industry."
          - name: "File Store"
            icon: "file-store-icon"
            link: "/help/file-store/"
            content: "Lorem Ipsum is simply dummy text of the printing and typesetting industry."
          - name: "Cache"
            icon: "cache-icon"
            link: "/help/cache/"          
      ...
      - title: "Amplify"
        featuredpoints:
          ...
          - name: "Push Notifications"
            ...
            link: "/help/push-notification/"
            content: "Lorem Ipsum is simply dummy text of the printing and typesetting industry."
          - name: "Event Listeners"
            icon: "event-listeners-icon"
            link: "/help/event-listener/"
            content: "Lorem Ipsum is simply dummy text of the printing and typesetting industry."
          - name: "Git"
            icon: "git-icon"
            link: "/help/git/"
